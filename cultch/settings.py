"""
Django settings for cultch project.
...
MIDDLEWARE = [
    ...
    'django.middleware.locale.LocaleMiddleware',  # locale language translation
]

ROOT_URLCONF = 'cultch.urls'
...
WSGI_APPLICATION = 'cultch.wsgi.application'
