...
play.success = function() {
    ...
    used /= 1000;
    if (used >= 0) {
        usedtime = Math.floor(used%60) + " �� ";
        used /= 60;
    }
    if (used >= 1) {
        usedtime = Math.floor(used%60) + " �� " + usedtime;
        used /= 60;
    }
    if (used >= 1) {
        usedtime = Math.floor(used%60) + " ʱ " + usedtime;
        used /= 60;
    }
    $('#time').text("����ʱ "  + usedtime + " ���� " + play.stepCount);
    $('#message').text("���� " + play.cheatCount + " ��  ���� " + play.undoCount + " ��");
